...
const basePath = config.personal?.domains?.basePath || ''

// https://astro.build/config
export default defineConfig({
  // Top-Level Options
  site: isGithubPages ? `https://${config.personal?.domains?.githubPages || 'example.github.io'}${basePath}/` : (isCloudflare ? `https://${config.personal?.domains?.cloudflare || 'example.pages.dev'}${basePath}/` : `https://${config.personal?.domains?.main || 'example.com'}${basePath}/`),
